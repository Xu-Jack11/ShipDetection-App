...
- Actions page: https://github.com/Xu-Jack11/ShipDetection-App/actions/workflows/windows-build.yml
- Latest run list: https://github.com/Xu-Jack11/ShipDetection-App/actions
- Release page (tag builds only): https://github.com/Xu-Jack11/ShipDetection-App/releases

### How to download

1. Open the Actions workflow page.
...
A GitHub Release asset is created automatically when you push a version tag:
...
The workflow uploads `SmartDetectionApp-windows.zip` to that Release.
